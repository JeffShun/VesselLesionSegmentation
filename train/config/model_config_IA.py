...
class IA_segmentation_cfg:
    ...
    train_dataset = MyDataset(
        dst_list_file = work_dir + "/train_data/processed_data/IA/train.txt",
        gaussian_sigma = 3,
    ...
    valid_dataset = MyDataset(
        dst_list_file = work_dir + "/train_data/processed_data/IA/valid.txt",
        gaussian_sigma = 3,
        transforms = TransformCompose([
            normlize(win_clip=True),
            to_tensor(),
    ...
    log_dir = work_dir + "/Logs/IA/ResUNet3D-RS-AUG-ASPP-32Ch"
    checkpoints_dir = work_dir + '/checkpoints/IA/ResUNet3D-RS-AUG-ASPP-32Ch'
    load_from = work_dir + '/checkpoints/IA/ResUNet3D-RS-AUG-32Ch/100.pth'
